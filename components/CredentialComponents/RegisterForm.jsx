  ...
  return (
    <form className="flex flex-col" onSubmit={handleFormSubmit}>
      ...
      <div className="flex flex-wrap flex-row justify-between">
        <div className="flex flex-col mb-4">
          <h2 className="mb-1 md:text-base text-2xl text-zinc-500 font-medium">First Name</h2>
          <input
            className={`border rounded-md px-2 py-1 ${
        ...
        <div className="flex flex-col mb-4">
          <h2 className="mb-1 md:text-base text-2xl text-zinc-500 font-medium">Last Name</h2>
          <input
            className={`border rounded-md px-2 py-1 ${
      ...
      <div className="flex flex-col mb-4">
        <h2 className="mb-1 md:text-base text-2xl text-zinc-500 font-medium">Role:</h2>
