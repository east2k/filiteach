    ...
    return (
        <section className="bg-gradient-to-b from-white to-purple-50">
            <div className="flex flex-col justify-between max-w-screen-2xl m-auto p-12">
                <h1 className="text-6xl text-center font-bold border-b border-b-purple-500 mb-7 mx-auto">
                    In Partnership With
                </h1>
                <div className="flex flex-col">
                    ...
                    <div className="w-full">
                        ...
                        <p className="text-center text-zinc-500 mb-10">
                            We reached out to teachers with years of teaching
                            experience
                        </p>
                        <div className="flex flex-row w-full flex-nowrap basis-1/4 gap-2">
                            {instructorList.map((item, index) => {
                                return (
                                    <div
                                        key={index}
                                        className="flex flex-col items-center justify-center w-1/4 border border-zinc-300 px-4 py-7"
                                    >
                                        ...
                                        <p className="text-purple-500 mb-3 text-center leading-5">
                                            Focus in: <br />
                                            {item.focusList}
                                        </p>
                                        <p className="text-zinc-500 mb-3 text-center">
                                            {item.experience} years of
                                            experience
                                        </p>
