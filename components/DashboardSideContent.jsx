  ...
  return (
    <div className="w-4/5 px-7 py-6">
      <h1 className="text-xl mb-3 font-medium">
        {role === "student" ? "Start Studying now!" : "Courses You Made"}
      </h1>
          ...
          <div className="grid grid-cols-3 bg-white rounded-lg ">
            ...
            <div className="flex flex-col p-3 col-span-2">
              ...
              <p className="mb-4 text-sm">
                ...
                Adipisci accusamus consequuntur velit perferendis ad qui quasi
                fuga ducimus impedit minima soluta quisquam error enim amet hic
                odio ut, ratione beatae.
              </p>
              <p className="text-sm">Instructor: Michael Adriano</p>
              <p className="text-sm">Points: 500</p>
              <p className="text-sm">Estimate time to Finish: 10 mins</p>
              <Link
