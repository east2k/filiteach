                ...
                return (
                    ...
                    >
                        <div className="flex flex-col items-center max-w-screen-2xl m-auto">
                            <h1 className="text-6xl text-left w-full font-bold border-b border-b-purple-500 mb-7">
                                {item.title}
                            </h1>
                            <div className="flex flex-row flex-nowrap w-full items-center">
                                <div className="basis-2/3 bg-purple-50 border border-purple-100 shadow-xl mx-5 rounded-md overflow-hidden">
                                    <h1 className="text-3xl font-medium tracking-wider text-center w-full text-white bg-purple-500 py-3 relative z-10 before:absolute before:-bottom-2 before:rotate-45 before:left-1/2 before:-translate-x-1/2 before:bg-purple-500 before:z-0 before:w-5 before:h-5">
                                        {item.price}
                                    </h1>
                                    ...
                                    <button className="text-white bg-purple-700 hover:bg-purple-500 w-full py-3 uppercase font-bold tracking-widest">
                                        Start now!
                                    </button>
                                </div>
