  ...
  return (
    <section className="flex flex-row w-full m-auto">
      <div className="fixed left-0 top-0 flex flex-col h-screen pt-4 shadow-2xl bg-white-600 items-center w-2/12">
        <div className="flex items-center justify-center border border-flush-orange-600 rounded-full w-32 h-auto">
          <Image
        ...
        <Link
          href="#"
          className="mt-auto text-white bg-flush-orange-500 hover:bg-flush-orange-400 w-full  px-3 py-14 text-center"
        >
          ChatBot
        </Link>
        <LogoutButton />
