        ...
        <div>
            <div className="border p-5 m-2">
                    ...
                    {courseParts.map((item, index) => {
                        return (
                            <div
                                ...
                                key={index}
                                className="flex flex-col cursor-pointer rounded-md text-white justify-center bg-purple-400 border border-white px-3 py-2 w-full h-32"
                            >
                ...
                <div className="border-t py-5">
                    ...
                    <div className="relative w-full border border-purple-500">
                        <div className="relative w-1/2 bg-purple-500 py-2"></div>
                    </div>
                </div>
                {preview && (
                    <div className="w-full py-5 border-t mb-10">
                        ...
                        <div className="flex flex-row gap-10">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p>Current Status</p>
                                <div className={`rounded-full w-28 border border-purple-200 ${preview.status ? "bg-green-500" : "bg-red-400"}`}>
                                    <p className="text-center text-sm py-2 px-3 text-white">{preview.status ? "Finished" : "Not Finished"}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-row justify-end gap-5">
                    <Link
                        ...
                        className="bg-purple-400 text-white px-16 py-2 mt-2 rounded-sm"
                    >
                        Start
                    </Link>
                    <Link
