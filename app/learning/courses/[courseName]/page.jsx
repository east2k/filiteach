    ...
    <div className="relative flex flex-row px-7 py-5 w-full h-full">
      <div className="w-2/3">
        ...
        <div className="mt-10 pr-5">
          ...
          <div className="border p-4 mb-7">This course is assigned to me!</div>
          <div className="border p-4">This course is part of your roadmap!</div>
        </div>
      </div>
      <div className="w-1/3">
        <div className="flex flex-col border shadow-md px-4 py-2 h-full">
          ...
          <p className="text-sm">
            ...
            tempora. Odit excepturi libero hic sapiente facere, quae enim quo
            sed. Iusto alias assumenda voluptas quibusdam nulla est mollitia!
            Cum, consequuntur!
          </p>
          ...
          <p className="mt-5 text-sm">Upload date: November 1, 2023</p>
      ...
      <div className="flex flex-col fixed right-5 bottom-5">
        <Link
          href="/learning/courses/anything/start"
          className="bg-flush-orange-400 text-white px-16 py-2 mt-2 rounded-sm"
        >
          Start
        </Link>
        <button className="bg-flush-orange-400 text-white px-16 py-2 mt-2 rounded-sm">
          Back
        </button>
      </div>
    </div>
