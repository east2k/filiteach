        ...
        <div>
            <div className="bg-purple-50 shadow-sm">
                <div className="flex flex-row items-center py-3 px-7">
                    <h1 className="text-4xl font-medium text-purple-600 tracking-wide">
                        Dashboard
                    </h1>
                </div>
            </div>
                ...
                {user.role === "student" && (
                    <div className="py-3 px-7 bg-blue-50">
                        ...
                        <div className="flex flex-row">
                            ...
                            <div className="w-1/3 bg-zinc-100 border border-purple-500 text-black rounded-lg py-5 px-3">
