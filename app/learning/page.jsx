    ...
    <div>
      ...
      <div className="flex flex-col">
          ...
          <div className="py-3 px-7 bg-blue-50">
            ...
            <div className="flex flex-row">
              ...
              <div className="w-1/3 bg-zinc-100 border border-flush-orange-500 text-black rounded-lg py-5 px-3">
                <h2 className="text-center text-xl mb-3">Event Title</h2>
                <p className="mb-5">
                  Description Lorem ipsum dolor sit amet consectetur adipisicing
                  elit. Deserunt dignissimos quaerat dicta atque beatae, alias
                  consequatur nostrum possimus reiciendis fuga consequuntur
                  iusto. Debitis, consequatur officiis ea quam earum architecto
                  corporis?
                </p>
        ...
        <div className="flex flex-row px-7 py-3">
          <DashboardSideContent role={user.role} />
