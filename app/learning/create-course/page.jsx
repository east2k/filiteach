    ...
    <div className="p-5">
      ...
      <div className="py-5">
        <div className="mx-auto bg-zinc-300 w-1/2 h-1 rounded-full">
          <div className="bg-flush-orange-500 h-full w-1/4"></div>
        </div>
        <div className="mx-auto w-1/2">
          <div className="relative w-full">
            <div className="absolute flex flex-col justify-center items-center left-1/4">
              <div className="relative -top-2 bg-flush-orange-500 p-1.5 w-1 h-1 rounded-full"></div>
            ...
            <div className="absolute flex flex-col justify-center items-center left-3/4">
              <div className="relative -top-2 bg-flush-orange-500 p-1.5 w-1 h-1 rounded-full"></div>
              <p className="absolute text-xs whitespace-nowrap top-1">Review</p>
            </div>
          </div>
        </div>
      </div>
