    ...
    <div className="mt-28">
      <section className="flex flex-row max-w-screen-2xl m-auto px-7 py-2 items-center">
        <div className="p-12">
          ...
          <p className="text-base text-zinc-700">
            Filiteach aims to solve lorem ipsum lorem ipsum lorem ipsum lorem
      ...
      <section className="flex flex-row bg-flush-orange-100 max-w-screen-2xl m-auto px-7 py-7">
        ...
        <div className="flex flex-col gap-4 p-12 w-1/2">
          <p>
            ...
            empower go-to-market professionals to deliver trusted and productive
            buyer experiences.
          </p>
          <p>
            We also believe in the power of AI to help sales and marketing teams
            unlock their creativity and connect with more prospects than ever
            before.
          </p>
          <p>
            We are committed to helping our customers grow their revenue faster
      ...
      <section className="flex flex-col items-center justify-center max-w-screen-2xl m-auto px-7 py-7">
        ...
        <p className="w-1/2 text-center">
          We aim to provide a solution for the SDG 4: Ensure inclusive and
